...
const ProfessorProfile = ({ navigation }) => {
          ...
          {rollNo && (
            <View style={styles.infoContainer}>
              <Icon
                ...
                style={styles.icon}
              />
              <Text style={styles.infoText}>{rollNo}</Text>
            </View>
          )}
  ...
  {phone ? (
    ...
    <Text style={styles.infoText}>No relevant info found</Text>
  )}
</View>
          ...
          <TouchableOpacity
            ...
            style={[styles.sectionHeader, styles.bioSection]}
          >
            <Text style={styles.sectionTitle}>Bio:</Text>
            <Icon
              name={isBioExpanded ? "expand-less" : "expand-more"}
              size={24}
              color="#004d40"
            />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            onPress={toggleEducationExpansion}
            style={[styles.sectionHeader, styles.educationSection]}
          >
            <Text style={styles.sectionTitle}>Education Qualifications:</Text>
            <Icon
              name={isEducationExpanded ? "expand-less" : "expand-more"}
              size={24}
              color="#004d40"
            />
          </TouchableOpacity>
