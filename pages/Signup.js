  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      await setDoc(doc(FIREBASE_DB, "users", uid), {
        ...
        photoURL:
          "https://img.freepik.com/free-vector/illustration-businessman_53876-5856.jpg?w=740&t=st=1721141254~exp=1721141854~hmac=16b7be7a26efb621a8073b1e8204f34be34595f0d723d5c8ae9279435c66a468", // Default profile image URL
        bio: "bio",
        phone: "+91",
      });
  ...
  return (
    <View className="flex-1 justify-center items-center bg-white p-4">
      ...
      <Pressable onPress={() => navigation.navigate("Login")} className="mt-4">
        ...
        <Text className="text-blue text-sm">
